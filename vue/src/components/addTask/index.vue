      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
              <div class="col-sm-10">
                <el-form-item prop='add'>
                  <el-input type="text" placeholder="请输入地址或者身份证号" v-model='ruleAddress.add' style="border-left: none">
         ...
         <!--     <label  class="col-sm-2 control-label form-label">地址</label>-->
              <button type="button" class="col-sm-2 btn btn-white" @click="submitForm('ruleAddress')">查询</button>
            </div>
            <!--地址备注-->
            <div class="form-group">
